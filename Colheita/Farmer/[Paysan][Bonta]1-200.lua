...
---------------------------------------------
-- Créateur : unlimited51, modifié par BiOcos & Kendaryth
-- Type : Récolte
-- Zone : Champs de Cania
-- Métier : Paysan
---------------------------------------------
MAX_PODS = 95 -- Retour en banque à 95% des PODS
...
-- 261 - Millet
--------
ELEMENTS_TO_GATHER = { 39 , 42 , 44 , 45 , 46 , 47 , 111 , 134 , 260 , 261 } -- Elements récoltés
BANK_PUT_ITEMS = {
{ item = 289, quantity = 0 }, --Blé
{ item = 400, quantity = 0 }, --Orge
{ item = 533, quantity = 0 }, --Avoine
{ item = 401, quantity = 0 }, --Houblon
{ item = 423, quantity = 0 }, --Lin
{ item = 532, quantity = 0 }, --Seigle
{ item = 425, quantity = 0 }, --Chanvre
{ item = 405, quantity = 0 }, --Malt
}
...
if jobLevel < 20 then
    ...
    elseif jobLevel < 160 then
        ...
        ELEMENTS_TO_GATHER = {44 , 46 , 47 } -- Paysan niveau 160 à 200, on ne fauche que le seigle, le chanvre et le malt
    end
end
...
function houblon()
    ...
    return {
        ...
        { map="-24,-42", changeMap = "right" },
        { map="-23,-42", changeMap = "bottom" },
        { map="-23,-41", gather = true, changeMap = "right" },
        { map="-22,-41", changeMap = "left" },
        { map="-23,-41", changeMap = "bottom" },
        { map="-23,-40", changeMap = "right" },
        { map="-22,-40", gather = true, changeMap = "bottom" },
        { map="-22,-39", changeMap = "left" },
        { map="-23,-39", changeMap = "left" },
        { map="-24,-39", gather = true, changeMap = "left" },
...
function lin()
    ...
    return {
        ...
        { map="-29,-41", changeMap = "right" },
        { map="-28,-41", changeMap = "right" },
        { map="-27,-41", gather = true, changeMap = "right" },
        { map="-26,-41", changeMap = "right" },
        { map="-25,-41", changeMap = "right" },
        { map="-24,-41", changeMap = "bottom" },
        { map="-24,-40", gather = true, changeMap = "right" },
        { map="-23,-40", changeMap = "bottom" },
...
function seigle()
    ...
    return {
        ...
        { map="-28,-40", gather = true, changeMap = "left" },
...
function malt()
    ...
    return {
        ...
        { map="-26,-42", gather = true, changeMap = "top" },
        { map="-26,-43", changeMap = "left" },
...
function chanvre()
    ...
    return {
        ...
        { map="-27,-43", changeMap = "right" },
        { map="-26,-43", gather = true, changeMap = "right" },
        { map="-25,-43", changeMap = "right" },
        { map="-24,-43", changeMap = "bottom" },
        { map="-24,-42", changeMap = "right" },
        { map="-23,-42", gather = true, changeMap = "bottom" },
        { map="-23,-41", changeMap = "right" },
        { map="-22,-41", changeMap = "left" },
        { map="-23,-41", changeMap = "bottom" },
        { map="-23,-40", changeMap = "right" },
        { map="-22,-40", changeMap = "bottom" },
...
function tout()
    ...
    return {
        ...
        { map="-28,-42", gather = true, changeMap = "bottom" },
        { map="-28,-41", changeMap = "right" },
        { map="-27,-41", gather = true, changeMap = "bottom" },
        { map="-27,-40", changeMap = "bottom" },
        { map="-27,-39", gather = true, changeMap = "left" },
